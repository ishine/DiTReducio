"""
Real-time FLOPs tracker for MegaTTS 3 inference.
...
class FLOPsTracker:
    ...
    def calculate_ff_flops(self, module, x):
        ...
        silu_ops = batch_size * seq_len * inner_dim
        linear2_ops = batch_size * seq_len * inner_dim * dim

        total_ops = linear1_ops + silu_ops + linear2_ops
    ...
    def register_hooks(self, model):
        ...
        for block in model.dit.encoder.layers:
            ...
            hook = block.feed_forward.register_forward_pre_hook(
    ...
    def get_summary(self):
        ...
        if self.total_flops > 0:
            ...
            summary.update(
                {"attention_percentage": 0, "ff_percentage": 0, "other_percentage": 0}
            )
    ...
    def print_summary(self):
        ...
        print("\n" + "=" * 50)
        print("MegaTTS3 Real-time FLOPs Analysis")
        print("=" * 50)
