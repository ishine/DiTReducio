"""Generate cross-sentence lst file for LibriSpeech test-other."""
import argparse
import json
import os
...
def main():
    ...
    parser.add_argument("--data_root", required=True, help="LibriSpeech-other data root directory")
    args = parser.parse_args()

    DATA_ROOT = args.data_root
    JSON_PATH = os.path.join(DATA_ROOT, "test-other.json")
    ...
    out_path = os.path.join(DATA_ROOT, "test_other_cross_sentence.lst")
